...
REM -static: no libc++.dll / libunwind.dll required (startup works without MinGW PATH)
set "LIBS=-static -lbcrypt -lshell32 -lcomctl32 -lole32 -luser32 -lgdi32 -ladvapi32 -lrpcrt4 -luuid -ldwmapi -lcomdlg32 -luxtheme -lwinhttp -mwindows"
set "SRCS=src\main.cpp src\app\Application.cpp src\app\NoteManager.cpp src\app\SecurityGuard.cpp src\app\UpdateChecker.cpp src\crypto\Auth.cpp src\crypto\Crypto.cpp src\crypto\VaultStorage.cpp src\crypto\PublicIndex.cpp src\model\Note.cpp src\ui\LockDialog.cpp src\ui\NoteWindow.cpp src\ui\NotesListWindow.cpp src\ui\TrayIcon.cpp"
